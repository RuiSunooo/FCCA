...
from DFEW_model import Creatmodel

from util_DFEW import read_split_data, train_one_epoch, evaluate
...
parser.add_argument('--data-path', type=str,
                    default=r"D:/codeagain/data/AFF7")
parser.add_argument('--workers', type=int, default=4, help='number of workers')
parser.add_argument('--raf_path', type=str, default='E:/codeagain/data', help='raf_dataset_path')
parser.add_argument('--label_path', type=str, default='AF7.txt', help='label_path')
...
def main(args):
    ...
    train_dataset = train_data_loader(data_set=args.data_set)
    test_dataset = test_data_loader(data_set=args.data_set)
    ...
    model = Creatmodel(args,pretrained=True).to(device)
